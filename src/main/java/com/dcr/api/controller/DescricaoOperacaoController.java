...
@RestController
@RequestMapping("/api/descricaoOperacao")
public class DescricaoOperacaoController {
	@Autowired
	AccdscopeService service;
	...
	public ResponseEntity<Object> getAll() {
		...
		try {
			List<Accdscope> lista = service.getAll();
	        if (lista.isEmpty()) {
	...
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<Object> getById(@RequestParam Integer idoper, @RequestParam String codidioma) {
	...
	public ResponseEntity<Object> create(@RequestBody AccdscopeDTO dto, HttpServletRequest request) {
	...
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<Object> update(@RequestBody AccdscopeDTO dto, HttpServletRequest request) {
	...
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<Object> delete(@RequestParam Integer idoper, @RequestParam String codidioma) {
