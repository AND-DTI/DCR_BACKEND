...
public class RegistroNoveController {
	...
	public ResponseEntity<Object> getAll() {
		...
		try {
			List<Dcrreg9> lista = service.getAll();
	        if (lista.isEmpty()) {
	...
	public ResponseEntity<Object> createregistro(@RequestBody Dcrreg9DTO dto, HttpServletRequest request) {
	...
	@ResponseStatus(HttpStatus.CREATED)
	public ResponseEntity<Object> update(@RequestBody Dcrreg9DTO dto, HttpServletRequest request) {
