...
public class RegistroUmController {
	...
	public ResponseEntity<Object> getAll() {
		...
		try {
			List<Dcrreg1> lista = service.getAll();
	        if (lista.isEmpty()) {
	...
	public ResponseEntity<Object> createRegistro(@RequestBody Dcrreg1DTO dto, HttpServletRequest request) {
		...
		try {
			...
			Optional<Dcrreg1> dcr = service.getByKey(key);
	...
	@ResponseStatus(HttpStatus.CREATED)
	public ResponseEntity<Object> update(@RequestBody Dcrreg1DTO dto, HttpServletRequest request) {
	...
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<Object> getByKey(@RequestBody Dcrreg1DTO dto, HttpServletRequest request) {
