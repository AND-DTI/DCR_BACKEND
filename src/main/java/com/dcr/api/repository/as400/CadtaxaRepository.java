...
public interface CadtaxaRepository extends JpaRepository<Cadtaxa, String> {
	@Query(value = "SELECT * FROM HD4DCDHH.CADTAXA AS cad ORDER BY TO_DATE(VIGFIM, 'YYYYMMDD') DESC FETCH FIRST 1 ROW ONLY", nativeQuery = true)
	Optional<Cadtaxa> getVigente();
