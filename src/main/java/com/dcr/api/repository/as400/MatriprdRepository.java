...
public interface MatriprdRepository  extends JpaRepository<Matriprd, Integer>{
	  ...
	  @Query(value = "SELECT prd.IDMATRIZ, prd.PRODUTO, prd.MODELO, prd.ANOMDL, prd.DESCCOM, prd.DESCRFB, prd.TPPRD, prd.PROTOT, prd.SPECIAL, \r\n"
	  		...
	  		+ "		DOC.CNPJFOR, DOC.IE, DOC.ADICAO, DOC.ITADICAO, DOC.CNPJFOR2, DOC.IE2, DOC.ADICAO2, DOC.ITADICAO2, DOC.CNPJFOR3, DOC.IE3, DOC.ADICAO3, DOC.ITADICAO3, INS.PARTNUMPD, PEND.PARTNUMPD, cor.CORPT, tppend.OBSPEND, pend.OBSRESOL  \r\n"
