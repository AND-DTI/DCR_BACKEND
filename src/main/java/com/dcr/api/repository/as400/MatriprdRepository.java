...
public interface MatriprdRepository  extends JpaRepository<Matriprd, Integer>{
	...
	SELECT 
		prd.IDMATRIZ, prd.PRODUTO, prd.MODELO, prd.ANOMDL, prd.DESCCOM, prd.DESCRFB, prd.TPPRD, prd.PROTOT, prd.SPECIAL, 
		prd.TPDCRE, prd.ORIGPRD, prd.DTNECI, prd.PRIOURGEN, prd.PREVFAT, prd.PRIORESP, prd.PRIODTMNT, prd.PRIOHRMNT,
		itm.PARTNUMPD, itm.CODCOR, cor.CORPT, itm.PARTDESC, itm.UNMED, itm.PRIOCOR, prc.status, cor.CDBEJ, cor.CORENG, cor.TPPIN, 
		pen.NUMPEND, pen.CDPEND, pen.OBSRESOL, pen.STATUS, tpe.descpend, tpe.obspend, pen.flex5flw as obsdetail, tpe.tpreg, /*27 ~ 34*/
		pen.PARTNUM, ins.PARTSUGEST, ins.PARTSUGDSC, ins.PARTNEW, ins.PARTNEWDSC,
		ins.PARTDESC, ins.ITMORG, ins.ITTYP, ins.UNMSR, ins.NECFIL, ins.CDSPN, ins.WEGHT, ins.EMCOMP, ins.ESPEC, ins.UNDCOM, ins.NCM, ins.VLRUNIT, /*40 ~ 51*/     
		doc.TPDOC, doc.NUMDOC, doc.SERDOC, doc.EMIDOC, doc.CNPJFOR, doc.IE, doc.ADICAO, doc.ITADICAO, doc.VLRUNIT, doc.SIGLAUND, doc.CODINCO, doc.MODAL, /*52 ~ 63*/   
		doc.NUMDOC2, doc.SERDOC2, doc.EMIDOC2, doc.CNPJFOR2, doc.IE2, doc.ADICAO2, doc.ITADICAO2, doc.VLRUNIT2, doc.SIGLAUND2, doc.CODINCO2, doc.MODAL2, /*64 ~ 74*/
		doc.NUMDOC3, doc.SERDOC3, doc.EMIDOC3,  doc.CNPJFOR3, doc.IE3, doc.ADICAO3, doc.ITADICAO3, doc.VLRUNIT3, doc.SIGLAUND3, doc.CODINCO3, doc.MODAL3  /*75 ~ 85*/  
	FROM 
	...
	List<Object[]> consultaProdutoPendencia(Integer idmatriz, String partnumpd);
		  ...
		  FROM 
			...
			HD4DCDHH.MATRIDOC as DOC on doc.IDMATRIZ= prd.IDMATRIZ and doc.PARTNUMPD= pen.PARTNUMPD and doc.partnum= pen.partnum 
		  WHERE 
			prc.STATUS IN :status 	--and prd.IDMATRIZ = 24	  
		  """, nativeQuery = true)
