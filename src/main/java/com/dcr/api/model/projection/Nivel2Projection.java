...
public class Nivel2Projection {
	private Object partnumPd;
	private Object descPor;
	private Object descIng;
	...
	public Object getDescIng() {
		return descIng;
	}
	public void setDescIng(Object descIng) {
		this.descIng = descIng;
	}
	public Object getuEngNo() {
		return uEngNo;
	}
	public void setuEngNo(Object uEngNo) {
		this.uEngNo = uEngNo;
	}
