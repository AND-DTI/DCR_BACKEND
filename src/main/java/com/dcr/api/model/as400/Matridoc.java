...
public class Matridoc {
	...
	public Matridoc(MatridocKey key, String numdoc, String serdoc, String emidoc, Long cnpjfor, String ie,
	...
	public MatridocKey getKey() {		return key;	}
	public void setKey(MatridocKey key) {		this.key = key;	}
