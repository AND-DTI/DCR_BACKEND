package com.ferapp.api.configs.persistence;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.ferapp.api.repository.as400", entityManagerFactoryRef = "as400_EntityManager", transactionManagerRef = "as400_TransactionManager")
public class PersistenceAS400Config {
    ...
    String ds_modelPackages = "com.ferapp.api.model.as400";
